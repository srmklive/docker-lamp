...
RUN apt-get update && apt-get -y upgrade && apt-get -y install apache2 php7.2 libapache2-mod-php7.2 php7.2-common \
  php7.2-cli php7.2-curl php7.2-mbstring php7.2-json \
